...
local OUTPUT_FILE = "/tmp/jest_test.json"

local M = {}

---@class JestBufferTestState: BufferTestState
---@field numTotalTests number

---@class JestTestInstanceState: TestInstanceState
---@field status TestState
---@field ancestorTitles string[] source Jest
---@field fullName string source Jest
---@field duration string source Jest
---@field failureMessages string[] source Jest
    ...
    local on_exit_callback = function()
        return function(_, exit_code, _)
            ...
            notify(
                ...
                "Jest " .. file_util.file_name(bufnr)
            )
...
M.command = function(bufnr, opts)
    ...
    -- search for rootfolder to pass to jest arguments
    local root_folder =
